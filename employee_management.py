...
class Employee :
    def __init__(self,root) :
        ...
        # 1st image
        img1 = Image.open('C:/Users/bobyd/OneDrive/Desktop/Python Project/images/img1.png')
        ...
        # 2nd image
        img2 = Image.open('C:/Users/bobyd/OneDrive/Desktop/Python Project/images/img3.png')
        ...
        # 3rd image
        img3 = Image.open('C:/Users/bobyd/OneDrive/Desktop/Python Project/images/img2.png')
        ...
        lbl_Married_status.grid(row=3,column=0,sticky=W)

        lbl_combo = ttk.Combobox(upper_frame,font=('arial',11,'bold'),width=20,state='readonly')
        lbl_combo['value'] =("Married","Un Married")
        lbl_combo.current(0)
        lbl_combo.grid(row=3,column=1,padx=2,sticky=W)
        ...
        lbl_combo.current(0)
        lbl_combo.grid(row=3,column=3,padx=2,sticky=W)

         #label for combo field for id_proof
        lbl_id_type = ttk.Combobox(upper_frame,font=('arial',11,'bold'),width=20,state='readonly')
        lbl_id_type['value'] =("Aadhar No.","PAN No.")
        lbl_id_type.current(0)
        lbl_id_type.grid(row=4,column=0,padx=2,sticky=W)

        entry_id_proof =Entry(upper_frame,textvariable=self.idProof,font=('arial',11,'bold'),width=20)
        entry_id_proof.grid(row=4,column=1,padx=2,sticky=W)

         #Add Employee Image
        employeeImg= Image.open('C:/Users/bobyd/OneDrive/Desktop/Python Project/images/dp.png')
        ...
        btn_reset = Button(button_frame,command=self.resetEmployeeInfo,text="Reset",font=('arial',12,'bold'),fg='white',bg='blue',width=12)
    ...
    def AddData(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="root",password="2016",database="employeeschema")
        cursor = conn.cursor()
        try:
    ...
    def deleteData(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="2016",database="employeeschema")
        cursor= conn.cursor()
